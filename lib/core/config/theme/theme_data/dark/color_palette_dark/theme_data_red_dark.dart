...
ThemeData getDarkRedTheme() {
  return ThemeData(
    bottomSheetTheme: const BottomSheetThemeData(
      backgroundColor: AppColors.redDarkScaffoldBackground,
    ),
    iconTheme: const IconThemeData(
      color: Colors.white,
    ),
    floatingActionButtonTheme: const FloatingActionButtonThemeData(
      backgroundColor: AppColors.redDarkPrimary100,
      foregroundColor: AppColors.grey0,
      elevation: 0,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(16)),
        side: BorderSide(
          color: AppColors.redDarkPrimary100,
          width: 2,
        ),
      ),
    ),
    ...
    scaffoldBackgroundColor: AppColors.redDarkScaffoldBackground,
    brightness: Brightness.dark,
    colorScheme: ColorScheme.fromSeed(
      // App Primary Colors in dark Mode
      seedColor: AppColors.redDarkPrimary100,
      brightness: Brightness.dark,
    ),
      ...
      fillColor: WidgetStateColor.resolveWith(
        (states) {
          if (states.contains(WidgetState.focused)) {
            return AppColors.redDarkPrimary100;
          } else {
